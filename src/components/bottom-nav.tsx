...
const items = [
  { label: "Sales", href: "/sales", icon: "home" },
    ...
    <>
      ...
      <nav data-brewery-ops-desktop className="fixed inset-x-0 top-0 z-50 hidden h-[61px] border-b border-slate-200 bg-white/95 backdrop-blur sm:block">
        <div className="mx-auto flex h-full max-w-5xl items-center justify-between px-6">
          <Link href="/sales" className="inline-flex items-center gap-2 text-sm font-bold tracking-tight text-slate-950" aria-label="Go to Sales home">
            <HomeIcon />
