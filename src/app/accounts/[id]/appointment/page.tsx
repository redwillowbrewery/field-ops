...
export default async function CreateAppointmentPage({
  ...
  searchParams: Promise<{ date?: string; interaction_id?: string }>;
}) {
  const { id } = await params;
  const { date, interaction_id: interactionId } = await searchParams;
